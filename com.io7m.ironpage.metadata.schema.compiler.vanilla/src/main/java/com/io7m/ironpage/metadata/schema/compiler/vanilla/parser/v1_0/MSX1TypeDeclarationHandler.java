...
/**
 * A handler for "DeclareType" elements.
 */

public final class MSX1TypeDeclarationHandler
  implements BTElementHandlerType<MAElementType<Parsed>, MADeclType<Parsed>>
{
  private final MADeclType.Builder<Parsed> builder;

  /**
   * Construct a handler.
   */

  public MSX1TypeDeclarationHandler()
  {
    this.builder = MADeclType.builder();
  }
  ...
  @Override
  public MADeclType<Parsed> onElementFinished(
    final BTElementParsingContextType context)
    throws SAXException
  {
    try {
    ...
    try {
      switch (result.kind()) {
        ...
        case TYPE_REFERENCE: {
          ...
          this.builder.setBaseType((MATypeReferenceType<Parsed>) result);
          break;
        }
        case COMMENT: {
