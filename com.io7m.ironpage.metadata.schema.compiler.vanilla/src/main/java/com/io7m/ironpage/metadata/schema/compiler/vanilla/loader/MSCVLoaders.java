...
import com.io7m.ironpage.metadata.schema.compiler.loader.api.MSchemaCompilerLoaderProviderType;
...
public final class MSCVLoaders implements MSchemaCompilerLoaderProviderType
{
  /**
  ...
  @Override
  public MSchemaCompilerLoaderType createLoader(
    final MSchemaCompilerProviderType compilers,
    final MSchemaCompilerErrorConsumerType errors,
    final MSchemaCompilerMessagesType messages,
    final MSchemaCompilerSourceType sources)
  {
    return new MSCVLoader(
