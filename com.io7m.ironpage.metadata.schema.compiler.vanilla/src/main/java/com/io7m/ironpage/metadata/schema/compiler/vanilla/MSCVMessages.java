...
final class MSCVMessages extends L10NStringsAbstract implements MSchemaCompilerMessagesType
{
  MSCVMessages(
    final Locale locale)
  {
    super("com.io7m.ironpage.metadata.schema.compiler.vanilla.Messages", locale);
  }
}
