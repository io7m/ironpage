...
public interface MADeclAttributeType<T> extends MAElementType<T>
{
  ...
  default Kind kind()
  {
    return Kind.ATTRIBUTE_DECLARATION;
  }
  ...
  /**
   * @return The declared type of the attribute
   */

  MATypeReferenceType<T> type();

  /**
   * @return The declared cardinality of the attribute
   */

  MACardinality cardinality();
