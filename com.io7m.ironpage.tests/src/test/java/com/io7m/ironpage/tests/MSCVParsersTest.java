...
@Tag("schemaCompiler")
public final class MSCVParsersTest extends MSchemaCompilerParserContract
{
  @Override
  protected MSchemaCompilerParserType createParser(
    final MSchemaCompilerErrorConsumerType errors,
    final MSchemaCompilerMessagesType messages,
    final URI uri,
    final InputStream stream)
  {
    return new MSCVParsers().createParser(errors, messages, uri, stream);
  }
}
