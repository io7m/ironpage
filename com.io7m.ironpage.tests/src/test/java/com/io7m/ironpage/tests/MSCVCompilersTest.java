...
public final class MSCVCompilersTest extends MSchemaCompilerContract
{
  @Override
  protected MSchemaCompilerLoaderType loader(final MSchemaCompilerSourceType source, final MSchemaCompilerErrorConsumerType errors)
  {
  ...
  @Override
  protected MSchemaCompilerType createCompiler(
    ...
    throws Exception
  {
    return new MSCVCompilers().createCompiler(errors, messages, loader, uri, stream);
  }
}
