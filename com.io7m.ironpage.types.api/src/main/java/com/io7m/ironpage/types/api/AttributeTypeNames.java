...
public final class AttributeTypeNames
{
  /**
   * The pattern that defines a valid type name.
   */

  public static final Pattern VALID_ATTRIBUTE_TYPE_NAME_PATTERN =
    Pattern.compile("[a-z][a-z0-9_]{0,127}");

  private AttributeTypeNames()
  {
  ...
  public static boolean isValidName(final String name)
  {
    ...
    return VALID_ATTRIBUTE_TYPE_NAME_PATTERN.matcher(name).matches();
  }
    ...
    if (!isValidName(name)) {
      throw new IllegalArgumentException(
        new StringBuilder(64)
          ...
          .append(name)
          .append(" (must match ")
          .append(VALID_ATTRIBUTE_TYPE_NAME_PATTERN.pattern())
          .append(")")
          .toString());
    }
    return name;
